...
const CampSite = ({ backgroudImage, title, subtitle, peopleJoined }:
  CampProps) => {
  return (
    <div className={`h-full w-full min-w-[1100px] ${backgroudImage}
    ...
    flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20'>
      ...
      justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]">
        <CampSite
          ...
          title="Trilha Convicto"
          subtitle="Piracicaba,São Paulo"
          peopleJoined="50+ Joined"
        />
        <CampSite
          backgroudImage="bg-bg-img-2"
          title="Serra do Mar"
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        ...
        rounded-3xl">
          <h2 className="regular-24 md:regular-32 2xl:regular-64 text-white">
            <strong>Sentindo-se Perdido </strong> e sem saber o caminho?
          </h2>
          <p className="regular-14 xl:regular-16 mt-5 text-white">
            Começando pela ansiedade dos alpinistas ao visitar um novo
            Clibing local, A possibilidade de se perder é muito grande.
            É por isso que estamos aqui para aqueles que desejam iniciar uma
            aventura
          </p>
          <Image
            src="/quote.svg"
